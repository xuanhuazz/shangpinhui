<template>
  <div class="detail">
    ...
    <section class="con">
      <!-- 导航路径区域 -->
      <div class="conPoin">
        <span>{{categoryView.category1Name}}、{{categoryView.category2Name}}、{{categoryView.category3Name}}</span>
        <span>手机</span>
        <span>Apple苹果</span>
        ...
        <div class="InfoWrap">
          ...
          <div class="choose" >
            <div class="chooseArea" >
              ...
              <dl v-for="spuSale in spuSaleAttrList" :key="spuSale.baseSaleAttrId">
                <dt class="title">{{spuSale.saleAttrName}}</dt>
                <dd changepirce="0" :class="{active : spuValue.isChecked == '1'}" v-for="spuValue in spuSale.spuSaleAttrValueList" :key="spuValue.baseSaleAttrId" @click="changeActive(spuValue,spuSale.spuSaleAttrValueList)">{{spuValue.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
